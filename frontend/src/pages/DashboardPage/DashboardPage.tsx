        ...
        const loadData = async () => {
            try {
                const [productsRes, materialsRes, productionRes] = await Promise.all([
                    ...
                    axios.get < ProductionResponse[] > ("/production"),
                ]);
        ...
        <div className="space-y-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p data-cy="products-count" className="text-3xl font-bold mt-4">
                        {productsCount} </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p data-cy="materials-count" className="text-3xl font-bold mt-4">
                        {materialsCount} </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p data-cy="production-value" className="text-2xl font-bold mt-4">
                        {
