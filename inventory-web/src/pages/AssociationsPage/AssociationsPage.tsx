...
export function AssociationsPage() {
        ...
        const loadData = async () => {
            try {
                const [productsRes, materialsRes] = await Promise.all([
                    ...
                    axios.get < RawMaterial[] > ("http://localhost:8080/raw-materials"),
                ]);
    ...
    const createAssociation = async () => {
        ...
        try {
            ...
            await axios.post("http://localhost:8080/product-compositions", {
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <select className="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                    ...
                    <input type="number" min="1" className="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Quantidade necessária"
                        value={quantity}
                        onChange={
